...
''';
    ...
    // FIX BUG 4: rimosso il try-catch interno che ingoiava gli errori.
    // Il WorkspaceViewModel ha già il suo try-catch che mostra lo stato
    // di errore all'utente. Se il Service non rilancia, il ViewModel
    // non saprà mai che qualcosa è andato storto.
